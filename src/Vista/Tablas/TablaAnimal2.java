 ...
 * @author josue
 */
public class TablaAnimal2 extends AbstractTableModel {
  private RegistroAnimal animal = new RegistroAnimal();

    public RegistroAnimal getAnimal() {
        return animal;
    }

    public void setAnimal(RegistroAnimal animal) {
        this.animal = animal;
    }
